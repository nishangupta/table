              ...
              <div class="col-12">
                  <div class="card card-outline card-primary">
                      ...
                      <div class="card-body text-muted">
                          ...
                          <form action="{{route('order.store',$reservation->id)}}" method="POST" enctype="multipart/form-data">
                              @csrf
                                  ...
                                  <div class="col-sm-6">
                                    ...
                                    <div class="form-group">
                                        <label>Customer Name <span class="text-danger">*</span></label>
                                         <input type="text" placeholder="customer name" class="form-control" name="customer_name" value="{{$reservation->name}}">
                                    </div>
                                  </div>
                                  <div class="col-sm-6">
                                      <div class="form-group">
...
$(document).ready(function() {
  ...
  $(".addbtn").on('click', function() {
      ...
      data += "<td><input class='form-control qty autocomplete_txt' value='1' type='number' data-type='qty' id='qty_" + i + "' name='qty[]'/></td>";
